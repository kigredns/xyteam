...
local ResizeBtn = SetChildren(SetProps(MakeElement("Button"), {
    ...
    local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
        ...
        SetChildren(SetProps(MakeElement("TFrame"), {
            ...
            SetProps(MakeElement("Label", "dsc.gg/xyteam", 12), {
    ...
    local TitleContainer = SetChildren(SetProps(MakeElement("TFrame"), {
    ...
    if WindowConfig.ShowIcon then
        TitleContainer.Position = UDim2.new(0, 60, 0, -24)
        ...
        local function GetElements(ItemParent)
            ...
            function ElementFunction:AddSlider(SliderConfig)
                ...
                local SliderBackground = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(100, 100, 110), 0, 5), {
                    ...
                    SetProps(MakeElement("Stroke", Color3.fromRGB(200, 200, 210), 0.06), {
                        Transparency = 0.3
                    })
                })
                ...
                local SliderBar = SetChildren(SetProps(MakeElement("TFrame"), {
                    Size = UDim2.new(1, -24, 0, 26),
                    Position = UDim2.new(0, 12, 0, 30),
                    BackgroundTransparency = 1,
                    ClipsDescendants = true,
                ...
                local function UpdateSlider()
                    if Dragging then 
                        ...
                        local SizeScale = math.clamp((MousePos.X - BarPos.X) / BarSize.X, 0, 1)
                ...
                function Slider:Set(Value)
                    ...
                    SliderBar.ValueText.Text = tostring(self.Value) .. " " .. SliderConfig.ValueName
                    SliderFill.Value.Text = tostring(self.Value) .. " " .. SliderConfig.ValueName
